//
//  VXFissionExtensionAUProcessHelper.hpp
//  VXFissionExtension
//
...
#include <vector>
#include "VXFissionExtensionDSPKernel.hpp"
#include "VXFissionExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(VXFissionExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
